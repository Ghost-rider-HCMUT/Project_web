...
<form action="" method="POST">
     <div class="card-body">
          ...
          <div class="form-group">
               <label for="menu">Sắp xếp</label>
     ...
     <div class="card-footer">
          <button type="submit" class="btn btn-primary">Cập Nhật Slider</button>
     </div>
     @csrf
</form>
@endsection